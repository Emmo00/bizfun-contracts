...
contract DeployFactory is Script {
    function run() external {
        ...
        uint256 creationFee = vm.envOr("CREATION_FEE", uint256(10e6)); // $10 USDC (6 decimals)
        uint256 initialLiquidity = vm.envOr("INITIAL_LIQUIDITY", uint256(5e6)); // $5 seeded into market
